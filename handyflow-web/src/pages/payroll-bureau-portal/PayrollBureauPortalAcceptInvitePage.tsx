// src/pages/payroll-bureau-portal/PayrollBureauPortalAcceptInvitePage.tsx
...
export function PayrollBureauPortalAcceptInvitePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const res = await payrollBureauPortalApi.register({ inviteToken: token, password, fullName })
