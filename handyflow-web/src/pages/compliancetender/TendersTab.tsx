          ...
          {["ALL", ...ALL_STATUSES].map(s => (
            <button key={s} onClick={() => setFilterStatus(s)}
              style={{ padding: "5px 12px", borderRadius: 20, fontSize: 12, cursor: "pointer", border: "none", fontWeight: filterStatus === s ? 600 : 400,
                background: filterStatus === s ? "#0369A1" : "#F1F5F9", color: filterStatus === s ? "#fff" : "#64748B" }}>
              ...
              <div key={t.id} onClick={() => nav(`/compliancetender/tenders/${t.id}`)}
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 14, minWidth: 0 }}>
                  <div style={{ width: 40, height: 40, borderRadius: 10, background: "#EFF6FF", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <Briefcase size={17} color="#0369A1" />
                  </div>
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 28, width: 620, maxHeight: "92vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", marginTop: 6 }}>
              ...
              <button onClick={() => {
                ...
                style={{ padding: "9px 22px", background: create.isPending ? "#94A3B8" : "#0369A1", color: "#fff", border: "none", borderRadius: 9, fontSize: 14, fontWeight: 700, cursor: create.isPending ? "not-allowed" : "pointer" }}>
