  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--hf-surface-sunken)", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <p style={{ fontSize: 13, color: "var(--hf-text-faint)", margin: "0 0 24px" }}>Placed portfolios and trust statements you have access to.</p>

        {isLoading ? (
          <p style={{ color: "var(--hf-text-faint)", fontSize: 13 }}>Loading…</p>
        ) : clients.length === 0 ? (
          <p style={{ color: "var(--hf-text-faint)", fontSize: 13 }}>You don't have access to any client portfolios yet.</p>
        ) : (
