    ...
    <div style={{ minHeight: "100vh", background: "var(--hf-surface-muted)", fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "28px 24px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 22 }}>
          ...
          <div>
            <h1 style={{ fontSize: 19, fontWeight: 800, color: "var(--hf-text)", margin: 0 }}>Warehousing</h1>
            <p style={{ fontSize: 12.5, color: "var(--hf-text-faint)", margin: 0 }}>3PL / public warehousing operations</p>
          </div>
        </div>
