    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(15,23,42,0.4)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "var(--hf-surface)", borderRadius: 16, padding: 28, width: 520, maxHeight: "85vh", overflowY: "auto" }}>
        ...
        <div style={{ display: "grid", gap: 12 }}>
          ...
          <p style={{ fontSize: 11, color: "var(--hf-text-faint)", margin: "2px 0 -4px" }}>Rate overrides — leave blank to use the operator's own default rate card</p>
        ...
        <button onClick={() => save.mutate()} disabled={!form.tradingName || save.isPending}
          style={{ marginTop: 18, width: "100%", padding: "11px", borderRadius: 8, border: "none", background: WHSE_ACCENT, color: "var(--hf-text-on-solid)", fontSize: 13.5, fontWeight: 700, cursor: "pointer", opacity: (!form.tradingName || save.isPending) ? 0.6 : 1 }}>
