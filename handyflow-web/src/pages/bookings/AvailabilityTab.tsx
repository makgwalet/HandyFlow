...
export default function AvailabilityTab() {
  ...
  const addBlock = useMutation({
    ...
    onSuccess: () => { setShowBlockModal(false); setBlockForm({ staffId: "", blockDate: "", startTime: "", endTime: "", reason: "" }) },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <button onClick={handleSaveAvailability} disabled={setAvailability.isPending}
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 }}>
            <div style={{ fontSize: 12, fontWeight: 600, color: "#94A3B8", textTransform: "uppercase" as const, letterSpacing: "0.05em" }}>Quick presets</div>
            {[
              ...
              <button key={preset.label}
                ...
                style={{ padding: "10px 14px", background: "#F8FAFC", border: "1px solid #E2E8F0", borderRadius: 8, fontSize: 13, cursor: "pointer", textAlign: "left" as const, color: "#374151", fontWeight: 500 }}>
                {preset.label}
              </button>
            ))}
          </div>
          ...
          <div style={{ padding: "14px 16px", background: "#FEF3C7", border: "1px solid #FCD34D", borderRadius: 8, fontSize: 12, color: "#92400E", lineHeight: 1.6 }}>
            <strong>Tip:</strong> Leave start and end time empty to block the entire day. Blocks prevent new bookings but don't affect existing confirmed bookings.
          </div>
        </div>
      </div>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(15,23,42,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, backdropFilter: "blur(2px)" }}>
          <div style={{ background: "#fff", borderRadius: 14, padding: 28, width: 460, boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", marginTop: 20 }}>
              <button onClick={() => setShowBlockModal(false)} style={{ padding: "9px 18px", border: "1px solid #E2E8F0", borderRadius: 9, background: "#fff", fontSize: 14, cursor: "pointer", color: "#374151" }}>Cancel</button>
              <button
