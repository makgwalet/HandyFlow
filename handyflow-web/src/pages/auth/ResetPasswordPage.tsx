    ...
    <div style={pageStyle}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ background: 'white', borderRadius: 20, padding: 32, textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 20, fontWeight: 700, color: 'var(--hf-text)', marginBottom: 10 }}>Invalid reset link</h2>
          <p style={{ fontSize: 14, color: 'var(--hf-text-muted)', marginBottom: 24, lineHeight: 1.6 }}>
        ...
        <div style={{ background: 'white', borderRadius: 20, padding: 32, boxShadow: '0 24px 80px rgba(0,0,0,0.3)' }}>
          {done ? (
            <div style={{ textAlign: 'center', padding: '8px 0' }}>
              ...
              <h2 style={{ fontSize: 20, fontWeight: 800, color: 'var(--hf-text)', margin: '0 0 8px' }}>Password reset</h2>
              <p style={{ fontSize: 14, color: 'var(--hf-text-muted)', lineHeight: 1.6, margin: '0 0 24px' }}>
                Your password has been changed successfully.
              </p>
              <button onClick={() => navigate('/login')}
                style={{ width: '100%', padding: '13px', background: 'var(--hf-primary)', color: 'white', border: 'none', borderRadius: 10, fontSize: 15, fontWeight: 700, cursor: 'pointer' }}>
                Sign in →
              </button>
            </div>
          ) : (
            <>
              ...
              <div style={{ marginBottom: 16 }}>
                <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--hf-text-secondary)', marginBottom: 5 }}>New password *</label>
              ...
              <div style={{ marginBottom: 20 }}>
                <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--hf-text-secondary)', marginBottom: 5 }}>Confirm new password *</label>
