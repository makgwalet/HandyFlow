      ...
      {showCreate && (
        <Modal title="Add Supplier" onClose={() => setShowCreate(false)}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <Field label="Company Name *" span={2}><input value={form.name} onChange={e => sf("name", e.target.value)} placeholder="Acme Suppliers (Pty) Ltd" style={inp} autoFocus /></Field>
            <Field label="Reg Number"><input value={form.registrationNumber} onChange={e => sf("registrationNumber", e.target.value)} placeholder="2020/123456/07" style={inp} /></Field>
            <Field label="VAT Number"><input value={form.vatNumber} onChange={e => sf("vatNumber", e.target.value)} placeholder="4570123456" style={inp} /></Field>
            ...
            <div style={{ gridColumn: "span 2", borderTop: "1px solid #F1F5F9", paddingTop: 12, marginTop: 4 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                ...
                <Field label="Email" span={2}><input type="email" value={form.contactEmail} onChange={e => sf("contactEmail", e.target.value)} style={inp} /></Field>
              </div>
            </div>
            ...
            <div style={{ gridColumn: "span 2", borderTop: "1px solid #F1F5F9", paddingTop: 12, marginTop: 4 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
                ...
                <Field label="Branch Code"><input value={form.bankBranchCode} onChange={e => sf("bankBranchCode", e.target.value)} placeholder="250655" style={inp} /></Field>
              </div>
            </div>

            <Field label="Notes" span={2}><textarea value={form.notes} onChange={e => sf("notes", e.target.value)} style={{ ...inp, minHeight: 50, resize: "vertical" }} /></Field>
          </div>
          {err && <ErrBox msg={err} />}
