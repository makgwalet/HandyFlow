          ...
          {todayShifts.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {todayShifts.map((shift: any) => {
                ...
                return (
                  <div key={shift.id} style={{ background: "var(--hf-surface)", border: `1px solid ${isActive ? "#86EFAC" : "#E2E8F0"}`, borderRadius: 10, padding: "14px 18px", display: "flex", alignItems: "center", gap: 14 }}>
