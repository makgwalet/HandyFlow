...
export default function AgingTab() {
  ...
  if (isLoading) return <div style={{ padding: 60, textAlign: "center", color: "#94A3B8" }}>Loading AP aging report...</div>
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        <div>
          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#0F172A", margin: 0 }}>AP Aging Report</h2>
      ...
      {!report || report.lines.length === 0 ? (
        <div style={{ padding: 60, textAlign: "center", background: "white", border: "1px solid #E2E8F0",
          ...
          <div style={{ fontWeight: 600, color: "#475569", marginBottom: 4 }}>All clear — no outstanding bills</div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {report.lines.map((line, i) => {
                ...
                return (
                  <tr key={line.billId} style={{ borderBottom: i < report.lines.length - 1 ? "1px solid #F8FAFC" : "none" }}
