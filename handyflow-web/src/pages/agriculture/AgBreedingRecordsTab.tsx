  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
        <p style={{ fontSize: 12.5, color: "var(--hf-text-muted)", margin: 0 }}>Mating → pregnancy confirmation → birth outcome.</p>
      ...
      {isLoading ? <p style={{ color: "var(--hf-text-faint)", fontSize: 12.5 }}>Loading…</p> :
        records.length === 0 ? <p style={{ color: "var(--hf-text-faint)", fontSize: 12.5 }}>No breeding records yet.</p> : (
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  {!r.actualBirthDate && (
                    <>
                      ...
                      <button onClick={() => failedMut.mutate(r.id)} title="Mark failed" style={{ ...iconBtn, color: "var(--hf-danger-text)" }}><XIcon size={12} /></button>
                    </>
                  )}
                </div>
              </div>
