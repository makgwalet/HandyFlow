// src/pages/recruitment-agency-portal/RecruitmentAgencyPortalLoginPage.tsx
...
export function RecruitmentAgencyPortalLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await recruitmentAgencyPortalApi.login({ email, password })
