...
@WebMvcTest(WhseController.class)
@Import(WebMvcTestSecuritySupport.class)
class WhseControllerTest {
    ...
    @DisplayName("GET /clients returns 200 with WAREHOUSING_READ")
    ...
    @DisplayName("GET /clients returns 403 without any WAREHOUSING_* authority")
    ...
    @Test
    @WithMockUser(authorities = "WAREHOUSING_READ")
    @DisplayName("POST /clients with only WAREHOUSING_READ returns 403")
    ...
    @DisplayName("POST /clients with WAREHOUSING_MANAGE returns 201")
    void createClientWithManageReturns201() throws Exception {
        when(clientService.create(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
    ...
    @Test
    @WithMockUser(authorities = "WAREHOUSING_MANAGE")
    @DisplayName("DELETE /clients/{id} with only WAREHOUSING_MANAGE returns 403 — ADMIN only")
    ...
    @DisplayName("DELETE /clients/{id} with WAREHOUSING_ADMIN returns 200")
