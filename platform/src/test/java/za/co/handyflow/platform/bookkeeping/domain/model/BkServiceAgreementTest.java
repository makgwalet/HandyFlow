...
class BkServiceAgreementTest {
    ...
    void retainerRequiresPositiveMonthlyFee() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> BkServiceAgreement.create(tenantId, clientId, "RETAINER", null, null, LocalDate.now(), null));
        assertThrows(IllegalArgumentException.class,
                () -> BkServiceAgreement.create(tenantId, clientId, "RETAINER", BigDecimal.ZERO, null, LocalDate.now(), null));
    }

    @Test
    void timeAndMaterialsDoesNotRequireMonthlyFee() {
        BkServiceAgreement agreement = BkServiceAgreement.create(TenantId.generate(), UUID.randomUUID(),
    ...
    void endDateMustBeAfterStartDate() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> BkServiceAgreement.create(tenantId, clientId, "TIME_AND_MATERIALS", null,
