 ...
 * every sibling provider module this engagement (AccPortalAccessGrant,
 * BookPortalAccessGrant, FmPortalAccessGrant, etc.).
 */
@Entity(name = "BkPortalAccessGrant")
@Table(name = "bk_portal_access_grants")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class BkPortalAccessGrant {
    ...
    public static BkPortalAccessGrant createInvite(UUID tenantId, UUID clientId,
                                                    String inviteEmail, UUID invitedBy) {
        BkPortalAccessGrant g = new BkPortalAccessGrant();
        g.tenantId = tenantId;
        g.clientId = clientId;
