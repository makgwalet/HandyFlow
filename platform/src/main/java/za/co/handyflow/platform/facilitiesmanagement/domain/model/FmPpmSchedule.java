...
/** Recurring maintenance plan against a client asset — mirrors Module 5a's own FacilityPpmSchedule. */
@Entity
@Table(name = "fm_ppm_schedules")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class FmPpmSchedule {
    ...
    public static FmPpmSchedule create(TenantId tenantId, UUID assetId, String taskName,
        ...
        FmPpmSchedule s = new FmPpmSchedule();
        s.tenantId = tenantId;
        s.assetId = assetId;
        s.taskName = taskName;
    ...
    public void update(String taskName, String description, Integer frequencyDays) {
        ...
        if (frequencyDays != null) {
            if (frequencyDays <= 0) throw new IllegalArgumentException("frequencyDays must be a positive number of days");
    ...
    public boolean isDue(LocalDate asOfDate) { return active && !nextDueDate.isAfter(asOfDate); }
