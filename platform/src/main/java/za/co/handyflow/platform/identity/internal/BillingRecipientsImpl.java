...
import za.co.handyflow.platform.notifications.application.BillingRecipients;
 ...
 * <p>
 * Implements BillingRecipients (in the shared notifications.application
 * package) rather than being depended on directly — FIX: an earlier
 * version of this class had no interface at all, meaning any other
 * module wiring it in would have needed to import identity.internal
 * directly, crossing a module boundary this codebase otherwise respects
 * consistently (TenantAdminRecipients follows exactly this same
 * interface/impl split for the same reason).
 * <p>
...
public class BillingRecipientsImpl implements BillingRecipients {
